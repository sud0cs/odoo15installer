...
then
    ...
    then
        ...
        pip3 install setuptools wheel PyPDF2 Babel chardet cryptography decorator docutils ebaysdk freezegun gevent greenlet idna Jinja2 libsass lxml MarkupSafe num2words ofxparse Pillow polib psutil psycopg2 pydot pyopenssl pyserial python-dateutil python-stdnum pytz pyusb qrcode reportlab requests urllib3 vobject Werkzeug xlrd XlsxWriter xlwt zeep
